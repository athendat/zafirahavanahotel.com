...
// src/app/shared/components/increment-control/increment-control.component.ts
var IncrementControlComponent = class _IncrementControlComponent {
  quantity = 0;
  increment = input(1);
  onChange = (quantity) => {
  };
  ...
  onKeyPressed(ev) {
    return ev.ctrlKey || ev.code.includes("Digit");
  }
  onChanged(ev) {
    this.markAsTouched();
    const el = ev.target;
    if (!isNaN(Number(el.value))) {
      this.quantity = Number(el.value);
    } else {
      this.quantity = 0;
    }
    this.onChange(this.quantity);
  ...
  static \u0275fac = function IncrementControlComponent_Factory(\u0275t) {
    return new (\u0275t || _IncrementControlComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IncrementControlComponent, selectors: [["zafira-increment-control"]], inputs: { increment: [1, "increment"] }, standalone: true, features: [\u0275\u0275ProvidersFeature([
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: _IncrementControlComponent
    }
  ]), \u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [["id", "d-room-count", 1, "de-number"], [1, "d-minus", 3, "click"], ["autocomplete", "off", 3, "keypress", "change", "value"], [1, "d-plus", 3, "click"]], template: function IncrementControlComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "span", 1);
      \u0275\u0275listener("click", function IncrementControlComponent_Template_span_click_1_listener() {
        return ctx.onRemove();
      });
      \u0275\u0275text(2, "-");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "input", 2);
      \u0275\u0275listener("keypress", function IncrementControlComponent_Template_input_keypress_3_listener($event) {
        return ctx.onKeyPressed($event);
      })("change", function IncrementControlComponent_Template_input_change_3_listener($event) {
        return ctx.onChanged($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "span", 3);
      \u0275\u0275listener("click", function IncrementControlComponent_Template_span_click_4_listener() {
        return ctx.onAdd();
      });
      \u0275\u0275text(5, "+");
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("value", ctx.quantity);
    }
  }, dependencies: [FormsModule], styles: ["\n\n.de-number[_ngcontent-%COMP%] {\n  display: flex;\n}\n.de-number[_ngcontent-%COMP%]    > *[_ngcontent-%COMP%] {\n  margin-bottom: 20px;\n}\n.de-number[_ngcontent-%COMP%]    > .d-minus[_ngcontent-%COMP%], \n.de-number[_ngcontent-%COMP%]    > .d-plus[_ngcontent-%COMP%] {\n  cursor: pointer;\n  color: #ffffff;\n  font-size: 20px;\n  width: 30px;\n  height: 30px;\n  padding: 3px 5px 3px 5px;\n  display: inline-block;\n  vertical-align: middle;\n  text-align: center;\n  -webkit-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}\n.d-minus[_ngcontent-%COMP%]:active, \n.d-plus[_ngcontent-%COMP%]:active {\n  background: #ffffff;\n  color: #000;\n}\n.de-number[_ngcontent-%COMP%]    > input[_ngcontent-%COMP%] {\n  margin: 0px 3px;\n  width: 40px;\n  text-align: center;\n  border: solid 1px rgba(255, 255, 255, 0.3);\n  border-radius: 4px;\n  color: #fff;\n  border-radius: 0 !important;\n  background: rgba(34, 34, 34, 0);\n  height: 30px;\n}\n.de-number[_ngcontent-%COMP%]    > input[_ngcontent-%COMP%]:focus {\n  border-color: var(--primary-color-1);\n}"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(IncrementControlComponent, { className: "IncrementControlComponent", filePath: "src\\app\\shared\\components\\increment-control\\increment-control.component.ts", lineNumber: 22 });
})();

// src/app/room/pipes/exclude-selected.pipe.ts
var ExcludeSelectedPipe = class _ExcludeSelectedPipe {
  transform(value, selected, excludeIndex) {
    const selectedIndexs = selected.filter((it) => it !== selected[excludeIndex]);
    const selectableRooms = value.filter((it) => !selectedIndexs.includes(it.$id));
    return selectableRooms;
  }
  static \u0275fac = function ExcludeSelectedPipe_Factory(\u0275t) {
    return new (\u0275t || _ExcludeSelectedPipe)();
  };
  static \u0275pipe = /* @__PURE__ */ \u0275\u0275definePipe({ name: "excludeSelected", type: _ExcludeSelectedPipe, pure: true, standalone: true });
};

// src/app/shared/utils/date-format.ts
function toIsoLocalTime(input2) {
  let value = new Date(input2 instanceof Date ? input2 : /* @__PURE__ */ new Date());
  const off = value.getTimezoneOffset() * -1;
  const del = value.getMilliseconds() ? "Z" : ".";
  value = new Date(value.getTime() + off * 6e4);
  return value.toISOString().split(del)[0] + (off < 0 ? "-" : "+") + ("0" + Math.abs(Math.floor(off / 60))).substr(-2) + ":" + ("0" + Math.abs(off % 60)).substr(-2);
}
...
var SharedResizeObserver = class _SharedResizeObserver {
  ...
  static \u0275fac = function SharedResizeObserver_Factory(\u0275t) {
...
var MatLabel = class _MatLabel {
  static \u0275fac = function MatLabel_Factory(\u0275t) {
...
var MatError = class _MatError {
  ...
  static \u0275fac = function MatError_Factory(\u0275t) {
    return new (\u0275t || _MatError)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    type: _MatError,
...
var MatHint = class _MatHint {
  ...
  static \u0275fac = function MatHint_Factory(\u0275t) {
...
var MatPrefix = class _MatPrefix {
  ...
  _isText = false;
  static \u0275fac = function MatPrefix_Factory(\u0275t) {
...
var MatSuffix = class _MatSuffix {
  ...
  _isText = false;
  static \u0275fac = function MatSuffix_Factory(\u0275t) {
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  static \u0275fac = function MatFormFieldFloatingLabel_Factory(\u0275t) {
    return new (\u0275t || _MatFormFieldFloatingLabel)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatFormFieldLineRipple = class _MatFormFieldLineRipple {
  ...
  static \u0275fac = function MatFormFieldLineRipple_Factory(\u0275t) {
    return new (\u0275t || _MatFormFieldLineRipple)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatFormFieldNotchedOutline = class _MatFormFieldNotchedOutline {
  ...
  static \u0275fac = function MatFormFieldNotchedOutline_Factory(\u0275t) {
    return new (\u0275t || _MatFormFieldNotchedOutline)();
  };
...
var MatFormFieldControl = class _MatFormFieldControl {
  ...
  static \u0275fac = function MatFormFieldControl_Factory(\u0275t) {
...
var MatFormField = class _MatFormField {
  ...
  static \u0275fac = function MatFormField_Factory(\u0275t) {
    return new (\u0275t || _MatFormField)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    type: _MatFormField,
...
var ShowOnDirtyErrorStateMatcher = class _ShowOnDirtyErrorStateMatcher {
  ...
  static \u0275fac = function ShowOnDirtyErrorStateMatcher_Factory(\u0275t) {
...
var ErrorStateMatcher = class _ErrorStateMatcher {
  ...
  static \u0275fac = function ErrorStateMatcher_Factory(\u0275t) {
...
var MatDatepickerIntl = class _MatDatepickerIntl {
  ...
  static \u0275fac = function MatDatepickerIntl_Factory(\u0275t) {
...
var MatCalendarBody = class _MatCalendarBody {
  ...
  static \u0275fac = function MatCalendarBody_Factory(\u0275t) {
    return new (\u0275t || _MatCalendarBody)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatDateSelectionModel = class _MatDateSelectionModel {
  ...
  static \u0275fac = function MatDateSelectionModel_Factory(\u0275t) {
    \u0275\u0275invalidFactory();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var MatSingleDateSelectionModel = class _MatSingleDateSelectionModel extends MatDateSelectionModel {
  ...
  static \u0275fac = function MatSingleDateSelectionModel_Factory(\u0275t) {
...
var MatRangeDateSelectionModel = class _MatRangeDateSelectionModel extends MatDateSelectionModel {
  ...
  static \u0275fac = function MatRangeDateSelectionModel_Factory(\u0275t) {
...
var DefaultMatCalendarRangeStrategy = class _DefaultMatCalendarRangeStrategy {
  ...
  static \u0275fac = function DefaultMatCalendarRangeStrategy_Factory(\u0275t) {
...
var MatMonthView = class _MatMonthView {
  ...
  static \u0275fac = function MatMonthView_Factory(\u0275t) {
    return new (\u0275t || _MatMonthView)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    type: _MatMonthView,
...
var MatMultiYearView = class _MatMultiYearView {
  ...
  static \u0275fac = function MatMultiYearView_Factory(\u0275t) {
    return new (\u0275t || _MatMultiYearView)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatYearView = class _MatYearView {
  ...
  static \u0275fac = function MatYearView_Factory(\u0275t) {
    return new (\u0275t || _MatYearView)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    type: _MatYearView,
...
var MatCalendarHeader = class _MatCalendarHeader {
  ...
  static \u0275fac = function MatCalendarHeader_Factory(\u0275t) {
    return new (\u0275t || _MatCalendarHeader)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatCalendar = class _MatCalendar {
  ...
  static \u0275fac = function MatCalendar_Factory(\u0275t) {
    return new (\u0275t || _MatCalendar)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    type: _MatCalendar,
...
var MatDatepickerContent = class _MatDatepickerContent {
  ...
  static \u0275fac = function MatDatepickerContent_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerContent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatDatepickerBase = class _MatDatepickerBase {
  ...
  static \u0275fac = function MatDatepickerBase_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerBase)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatDatepickerInputBase = class _MatDatepickerInputBase {
  ...
  static \u0275fac = function MatDatepickerInputBase_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerInputBase)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  ...
  static \u0275fac = function MatDatepickerInput_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerInput)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatDatepickerToggleIcon = class _MatDatepickerToggleIcon {
  static \u0275fac = function MatDatepickerToggleIcon_Factory(\u0275t) {
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  ...
  static \u0275fac = function MatDatepickerToggle_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerToggle)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatDateRangeInput = class _MatDateRangeInput {
  ...
  static \u0275fac = function MatDateRangeInput_Factory(\u0275t) {
    return new (\u0275t || _MatDateRangeInput)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatDateRangeInputPartBase = class _MatDateRangeInputPartBase extends MatDatepickerInputBase {
  ...
  static \u0275fac = function MatDateRangeInputPartBase_Factory(\u0275t) {
    return new (\u0275t || _MatDateRangeInputPartBase)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatStartDate = class _MatStartDate extends MatDateRangeInputPartBase {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    ...
    return function MatStartDate_Factory(\u0275t) {
      return (\u0275MatStartDate_BaseFactory || (\u0275MatStartDate_BaseFactory = \u0275\u0275getInheritedFactory(_MatStartDate)))(\u0275t || _MatStartDate);
    };
  })();
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    type: _MatStartDate,
...
var MatEndDate = class _MatEndDate extends MatDateRangeInputPartBase {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    ...
    return function MatEndDate_Factory(\u0275t) {
      return (\u0275MatEndDate_BaseFactory || (\u0275MatEndDate_BaseFactory = \u0275\u0275getInheritedFactory(_MatEndDate)))(\u0275t || _MatEndDate);
    };
  })();
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    type: _MatEndDate,
...
var MatDatepickerApply = class _MatDatepickerApply {
  ...
  static \u0275fac = function MatDatepickerApply_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerApply)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatDatepickerCancel = class _MatDatepickerCancel {
  ...
  static \u0275fac = function MatDatepickerCancel_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerCancel)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var MatDatepickerActions = class _MatDatepickerActions {
  ...
  static \u0275fac = function MatDatepickerActions_Factory(\u0275t) {
    return new (\u0275t || _MatDatepickerActions)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var MatDatepickerModule = class _MatDatepickerModule {
  static \u0275fac = function MatDatepickerModule_Factory(\u0275t) {
...
var _CdkTextFieldStyleLoader = class __CdkTextFieldStyleLoader {
  static \u0275fac = function _CdkTextFieldStyleLoader_Factory(\u0275t) {
    return new (\u0275t || __CdkTextFieldStyleLoader)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
var AutofillMonitor = class _AutofillMonitor {
  ...
  static \u0275fac = function AutofillMonitor_Factory(\u0275t) {
    return new (\u0275t || _AutofillMonitor)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var CdkAutofill = class _CdkAutofill {
  ...
  static \u0275fac = function CdkAutofill_Factory(\u0275t) {
    return new (\u0275t || _CdkAutofill)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    type: _CdkAutofill,
...
var CdkTextareaAutosize = class _CdkTextareaAutosize {
  ...
  static \u0275fac = function CdkTextareaAutosize_Factory(\u0275t) {
    return new (\u0275t || _CdkTextareaAutosize)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var TextFieldModule = class _TextFieldModule {
  static \u0275fac = function TextFieldModule_Factory(\u0275t) {
...
var MatFormFieldModule = class _MatFormFieldModule {
  static \u0275fac = function MatFormFieldModule_Factory(\u0275t) {
...
var MatInput = class _MatInput {
  ...
  static \u0275fac = function MatInput_Factory(\u0275t) {
    return new (\u0275t || _MatInput)();
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
    type: _MatInput,
...
var MatInputModule = class _MatInputModule {
  static \u0275fac = function MatInputModule_Factory(\u0275t) {
...
var NativeDateAdapter = class _NativeDateAdapter extends DateAdapter {
  ...
  static \u0275fac = function NativeDateAdapter_Factory(\u0275t) {
    return new (\u0275t || _NativeDateAdapter)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var NativeDateModule = class _NativeDateModule {
  static \u0275fac = function NativeDateModule_Factory(\u0275t) {
...
var MatNativeDateModule = class _MatNativeDateModule {
  static \u0275fac = function MatNativeDateModule_Factory(\u0275t) {
...
// src/app/room/components/booking/booking.component.ts
var _forTrack02 = ($index, $item) => $item.$id;
var _c03 = (a0, a1) => ({ "invalid": a0, "valid": a1 });
var _c13 = (a0) => ({ "invalid": a0 });
function BookingComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11);
    \u0275\u0275element(1, "i", 48);
    \u0275\u0275text(2, " Your reservation is pending payment. Please complete the process. ");
    \u0275\u0275elementEnd();
  }
}
function BookingComponent_For_47_For_8_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", room_r4.name, " - $", room_r4.price, " per night");
  }
}
function BookingComponent_For_47_ForEmpty_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 51);
...
function BookingComponent_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 28)(1, "h4");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 32)(4, "select", 49);
    \u0275\u0275listener("change", function BookingComponent_For_47_Template_select_change_4_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateReservationSummary());
    });
    \u0275\u0275elementStart(5, "option", 50);
    \u0275\u0275text(6, "Select a room type");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(7, BookingComponent_For_47_For_8_Template, 2, 3, "option", 51, _forTrack02, false, BookingComponent_For_47_ForEmpty_9_Template, 2, 1, "option", 51);
    \u0275\u0275pipe(10, "excludeSelected");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Room #", $index_r6 + 1, "");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(8, _c13, item_r5.touched && item_r5.invalid));
    \u0275\u0275advance();
    \u0275\u0275property("formControlName", $index_r6);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(\u0275\u0275pipeBind3(10, 4, ctx_r1.rooms(), ctx_r1.selectedRooms(), $index_r6));
  }
}
function BookingComponent_Conditional_48_For_30_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const roomId_r7 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r1.getRoomName(roomId_r7), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("$", ctx_r1.getRoomPrice(roomId_r7), " \xD7 ", ctx_r1.calculateNights(), " night(s)");
  }
}
function BookingComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 29)(1, "h4");
    \u0275\u0275element(2, "i", 52);
    \u0275\u0275text(3, " Reservation summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 53)(5, "span");
    \u0275\u0275text(6, "Check-in:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 53)(10, "span");
    \u0275\u0275text(11, "Check-out:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(14, "div", 53)(15, "span");
    \u0275\u0275text(16, "Duration:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "span");
    \u0275\u0275text(18);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "div", 53)(20, "span");
    \u0275\u0275text(21, "Rooms:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "span");
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "div", 53)(25, "span");
    \u0275\u0275text(26, "Guests:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "span");
    \u0275\u0275text(28);
    \u0275\u0275elementEnd()();
    \u0275\u0275repeaterCreate(29, BookingComponent_Conditional_48_For_30_Template, 5, 3, "div", 53, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementStart(31, "div", 54)(32, "span");
    \u0275\u0275text(33, "Total:");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r1.formatDate(ctx_r1.checkInDate.value));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatDate(ctx_r1.checkOutDate.value));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("", ctx_r1.calculateNights(), " night(s)");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.roomQuantity.value);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2("", ctx_r1.adultQuantity.value, " adult(s), ", ctx_r1.childrenQuantity.value, " child(ren)");
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.selectedRooms());
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("$", ctx_r1.calculateTotal(), "");
  }
}
function BookingComponent_Conditional_57_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingComponent_Conditional_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
...
function BookingComponent_Conditional_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
...
function BookingComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275text(1, " Please enter your ID number. ");
    \u0275\u0275elementEnd();
  }
}
function BookingComponent_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 55);
    \u0275\u0275listener("click", function BookingComponent_Conditional_74_Template_input_click_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      const reservation_r9 = \u0275\u0275readContextLet(73);
      return \u0275\u0275resetView(ctx_r1.openPaymentWindows(reservation_r9.payments[0].link));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "input", 56);
    \u0275\u0275listener("click", function BookingComponent_Conditional_74_Template_input_click_1_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.cancelBooking());
    });
    \u0275\u0275elementEnd();
  }
}
function BookingComponent_Conditional_75_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275element(1, "i", 57);
    \u0275\u0275text(2, " Your reservation has been confirmed successfully! ");
    \u0275\u0275elementEnd();
  }
}
function BookingComponent_Conditional_79_Template(rf, ctx) {
  if (rf & 1) {
...
function BookingComponent_Conditional_80_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275element(1, "div", 58);
    \u0275\u0275elementEnd();
...
var BookingComponent = class _BookingComponent {
  ...
  rooms = this._roomSrv.availableRooms;
  selectedRooms = signal([]);
  bookingStatus = signal("INITIAL");
  roomStatus = this._roomSrv.requestStatus;
  activeReservation = this._roomSrv.reservation;
  errorMessage = signal("");
  subRef = null;
  ...
  frm = this._fb.group({
    ...
    adultQuantity: new FormControl(1, [
      Validators.required,
      Validators.min(1)
    ]),
    childrenQuantity: new FormControl(0, [
      Validators.required,
      Validators.min(0)
    ]),
    ...
    rooms: this._fb.array([], { validators: Validators.required }),
  ...
  checkAvailableRoomsFormControl = new FormControl([]);
  constructor() {
    effect(() => {
      this.checkAvailableRoomsFormControl.setValue(this._roomSrv.availableRooms());
    });
  }
  get checkInDate() {
    return this.frm.controls["checkInDate"];
  }
  get checkOutDate() {
    return this.frm.controls["checkOutDate"];
  }
  get adultQuantity() {
    return this.frm.controls["adultQuantity"];
  }
  get childrenQuantity() {
    return this.frm.controls["childrenQuantity"];
  }
  get roomQuantity() {
    return this.frm.controls["roomQuantity"];
  }
  get firstName() {
    return this.frm.controls["firstName"];
  }
  get email() {
  ...
  get idNumber() {
    return this.frm.controls["idNumber"];
  }
  get message() {
    return this.frm.controls["message"];
  }
  get roomTypes() {
    return this.frm.controls["rooms"];
  }
  ngOnInit() {
    this._observeDate();
    this._observeGuestsChange();
    this._observeRoomTypes();
    this._initData();
    this._observeRoomCount();
    this.checkAvailableRoomsFormControl.valueChanges.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((rooms) => {
      this._observeAvailableRooms(rooms);
    });
  }
  ngOnDestroy() {
    this._roomSrv.clearAvailableRooms();
    if (this.subRef) {
      this.subRef();
    }
  }
  // Método para actualizar el resumen de la reserva cuando cambia la selección
  updateReservationSummary() {
    console.log("Actualizando resumen de reserva");
  }
  // Método para formatear fechas en el resumen
  formatDate(date) {
    if (!date)
      return "No seleccionada";
    return this._datePipe.transform(date, "dd/MM/yyyy") || "Fecha inv\xE1lida";
  }
  ...
  // Obtener nombre de la habitación por ID
  getRoomName(roomId) {
    const foundRoom = this.rooms().find((room) => room.$id === roomId);
    return foundRoom ? foundRoom.name : "Habitaci\xF3n";
  }
  // Obtener precio de la habitación por ID
  getRoomPrice(roomId) {
    const foundRoom = this.rooms().find((room) => room.$id === roomId);
    return foundRoom ? foundRoom.price : 0;
  }
  ...
  onSubmit() {
    if (this.frm.invalid) {
      ...
      this.roomTypes.controls.forEach((control) => control.markAsTouched());
      return;
    }
    this.bookingStatus.set("LOADING");
    const data = this.frm.getRawValue();
    const checkInDate = data.checkInDate ? toIsoLocalTime(data.checkInDate) : "";
    const checkOutDate = data.checkOutDate ? toIsoLocalTime(data.checkOutDate) : "";
    const requestData = {
      ...
      paymentGateway: "TROPIPAY",
      roomQuantity: data.roomQuantity ?? 0,
      rooms: data.rooms ?? [],
      observations: data.message ?? ""
    };
    this._roomSrv.bookRoom(requestData).then((rta) => {
      console.log(rta);
      if (rta.status === "failed") {
        const err = JSON.parse(rta.responseBody);
        this.errorMessage.set(err.message);
        throw Error("Reservation failed");
      }
      const data2 = JSON.parse(rta.responseBody);
      console.log(JSON.parse(rta.responseBody));
      if (JSON.parse(rta.responseBody)?.statusCode && JSON.parse(rta.responseBody).ok === false) {
        const err = JSON.parse(rta.responseBody);
        this.errorMessage.set(err.message);
        throw Error("Reservation failed");
      }
      this._roomSrv.setReservation(data2);
      if (data2.payments && data2.payments.length > 0) {
        this._subscribeRealtime(data2.payments[0]);
        this.windowRef = window.open(data2.payments[0].link, "_blank");
  ...
  openPaymentWindows(link) {
    this.windowRef = window.open(link, "_blank");
    this.windowRef?.focus();
  }
  cancelBooking() {
    this.resetBooking();
  ...
  _initData() {
    const activeReservation = this.activeReservation();
    if (activeReservation) {
      this.bookingStatus.set("PENDING");
      this._roomSrv.getReservation(activeReservation.$id).then((frmData) => {
        this._roomSrv.setReservation(frmData);
        const start = new Date(frmData.checkInDate);
        const end = new Date(frmData.checkOutDate);
        this.checkInDate.setValue(start);
        this.checkOutDate.setValue(end);
        for (let index = 0; index < frmData.rooms.length; index++) {
          this.roomTypes.push(new FormControl("", [Validators.required]));
        }
        this.frm.patchValue({
          adultQuantity: frmData.adultQuantity,
          checkInDate: new Date(frmData.checkInDate),
          checkOutDate: new Date(frmData.checkOutDate),
          childrenQuantity: frmData.childrenQuantity,
          email: frmData.customer.email,
          firstName: frmData.customer.firstName,
          idNumber: frmData.customer.idNumber,
          message: frmData.observations,
          phone: frmData.customer.phoneNumber,
          roomQuantity: frmData.roomQuantity
        });
        const roomValues = frmData.rooms.map((e) => e.$id);
        this.roomTypes.controls.forEach((control, index) => {
          if (index < roomValues.length) {
            control.setValue(roomValues[index]);
          }
        });
        if (frmData.payments && frmData.payments[0] && frmData.paymentStatus === "Pagado") {
          this.dialogRef().openModalDialog();
          this.bookingStatus.set("SUCCESS");
          this._roomSrv.clearActiveReservation();
          this._roomSrv.clearSelectedRoom();
          this._roomSrv.clearAvailableRooms();
        ...
        } else if (frmData.paymentStatus !== "Pagado") {
          this._subscribeRealtime(frmData.payments[0]);
        }
      });
    } else {
      const start = /* @__PURE__ */ new Date();
      const end = /* @__PURE__ */ new Date();
      end.setDate((/* @__PURE__ */ new Date()).getDate() + 1);
      this.checkInDate.setValue(start);
      this.checkOutDate.setValue(end);
      this.roomQuantity.setValue(1);
      const room = this._route.snapshot.paramMap.get("room");
      if (room) {
        this.roomTypes.push(new FormControl(room, [Validators.required]));
      } else {
        this.roomTypes.push(new FormControl("", [Validators.required]));
      }
    }
  ...
  _observeRoomCount() {
    this.roomQuantity?.valueChanges.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((v) => {
      if (v !== null) {
        const limit = (this.roomQuantity?.value ?? 0) - this.roomTypes.controls.length;
        if (limit <= 0) {
          for (let index = 0; index < Math.abs(limit); index++) {
            this.roomTypes.removeAt(this.roomTypes.controls.length - index - 1);
          }
        } else {
  ...
  _observeRoomTypes() {
    this.roomTypes?.valueChanges.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((v) => {
      this.selectedRooms.set(v.filter((e) => e !== "-1"));
    });
  }
  _observeGuestsChange() {
  }
  _observeDate() {
    this.checkOutDate.valueChanges.pipe(takeUntilDestroyed(this._destroyRef)).subscribe((v) => {
      if (this.checkInDate.value && this.checkOutDate.value) {
        const data = {
          checkInDate: toIsoLocalTime(this.checkInDate.value),
          checkOutDate: toIsoLocalTime(this.checkOutDate.value)
        };
        if (this.checkInDate.value && this.checkOutDate.value) {
          this._roomSrv.getAvailableRooms(JSON.stringify(data));
        }
      }
    });
    this.checkInDate.valueChanges.pipe(takeUntilDestroyed(this._destroyRef), debounceTime(500)).subscribe((v) => {
      if (this.checkInDate.value && this.checkOutDate.value) {
        const data = {
          checkInDate: toIsoLocalTime(this.checkInDate.value),
          checkOutDate: toIsoLocalTime(this.checkOutDate.value)
  ...
  _observeAvailableRooms(availableRooms) {
    ...
    this.roomTypes.controls.forEach((control, index) => {
      ...
      if (roomId && roomId !== "" && roomId !== "-1" && !availableRoomIds.includes(roomId)) {
        control.setValue("");
        needsUpdate = true;
      }
    });
    if (needsUpdate) {
      this.selectedRooms.set(this.roomTypes.controls.map((control) => control.value).filter((id) => id && id !== "" && id !== "-1"));
    }
  }
  _calculateAmmount() {
    return this.calculateTotal();
  }
  _subscribeRealtime(data) {
    this.subRef = this._roomSrv.listenChannel(`databases.${environment.appwrite.databaseId}.collections.${APP_WRITE_CONFIG.paymentCollectionId}.documents.${data.$id}`, (responseEv) => {
      this.dialogRef().openModalDialog();
      this.bookingStatus.set("SUCCESS");
      this.resetBooking();
      this.windowRef?.close();
  ...
  static \u0275fac = function BookingComponent_Factory(\u0275t) {
    return new (\u0275t || _BookingComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookingComponent, selectors: [["zafira-booking"]], viewQuery: function BookingComponent_Query(rf, ctx) {
    if (rf & 1) {
    ...
    // Proveer el adaptador de fechas nativo
    DatePipe
  ]), \u0275\u0275StandaloneFeature], decls: 81, vars: 33, consts: [["picker", ""], ["confirmDialog", ""], ["id", "background"], ["id", "content-absolute"], ["title", "Booking", "subtitle", "Reserve your perfect stay with us"], ["id", "section-main", "data-wow-delay", "1.5s", "aria-label", "section-menu", 1, "no-bg", "no-top", "wow", "fadeInUp", "animated"], [1, "container"], [1, "row"], [1, "col-lg-8", "offset-lg-2"], [1, "de-content-overlay"], [1, "form-status", "error"], [1, "form-status", "pending"], ["name", "contactForm", "id", "contact_form", 3, "ngSubmit", "formGroup"], [1, "booking-section"], [1, "fa", "fa-calendar"], [1, "col-md-12"], ["appearance", "outline", 1, "w-100"], [3, "rangePicker", "min"], ["matStartDate", "", "placeholder", "Check-in date", "formControlName", "checkInDate"], ["matEndDate", "", "placeholder", "Check-out date", "formControlName", "checkOutDate"], ["matIconSuffix", "", 3, "for"], [1, "guests-n-rooms"], [1, "col-md-4"], ["formControlName", "adultQuantity"], ["formControlName", "childrenQuantity"], ["formControlName", "roomQuantity"], [1, "fa", "fa-bed"], ["formArrayName", "rooms"], [1, "select-room"], [1, "booking-section", "booking-summary"], [1, "fa", "fa-user"], [1, "col-md-6"], [1, "form-control-wrapper", 3, "ngClass"], ["type", "text", "placeholder", "Your name", "formControlName", "firstName", 1, "form-control"], [1, "error"], ["type", "email", "placeholder", "Your email", "formControlName", "email", 1, "form-control"], ["type", "tel", "placeholder", "Your phone", "formControlName", "phone", 1, "form-control"], ["type", "text", "placeholder", "Your ID number", "formControlName", "idNumber", 1, "form-control"], [1, "form-control-wrapper"], ["placeholder", "Additional comments or special requirements", "formControlName", "message", 1, "form-control"], [1, "row", "mt-4"], [1, "col-md-12", "text-center"], ["type", "submit", "id", "send_message", 1, "mt10", "mr10", "btn", "btn-line", 3, "value", "disabled"], [1, "success"], ["containerClass", "container-fluid"], ["header", "Payment Status", "cancelBtn", "NONE", "confirmBtn", "Accept", "dialogText", "Congratulations! Your reservation payment has been successfully processed. We look forward to welcoming you to our hotel."], [1, "loading-overlay"], [1, "fa", "fa-exclamation-circle"], [1, "fa", "fa-clock-o"], ["name", "Room Type", "id", "room-type", 1, "form-control", 3, "change", "formControlName"], ["value", "", "disabled", "", "selected", ""], [3, "value"], [1, "fa", "fa-file-text"], [1, "summary-item"], [1, "summary-total"], ["type", "button", "value", "Go to Payment", 1, "mt10", "mr10", "btn", "btn-line", 3, "click"], ["type", "button", "value", "Cancel Reservation", 1, "mt10", "mr10", "btn", "btn-line", 3, "click"], [1, "fa", "fa-check-circle"], [1, "spinner"]], template: function BookingComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "zafira-float-text")(1, "div", 2);
      \u0275\u0275elementStart(2, "div", 3);
      \u0275\u0275element(3, "zafira-subheader", 4);
      \u0275\u0275elementStart(4, "section", 5)(5, "div", 6)(6, "div", 7)(7, "div", 8)(8, "div", 9);
      \u0275\u0275template(9, BookingComponent_Conditional_9_Template, 3, 1, "div", 10)(10, BookingComponent_Conditional_10_Template, 3, 0, "div", 11);
      \u0275\u0275elementStart(11, "form", 12);
      \u0275\u0275listener("ngSubmit", function BookingComponent_Template_form_ngSubmit_11_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onSubmit());
      });
      \u0275\u0275elementStart(12, "div", 13)(13, "h4");
      \u0275\u0275element(14, "i", 14);
      \u0275\u0275text(15, " Select your dates");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "div", 7)(17, "div", 15)(18, "mat-form-field", 16)(19, "mat-label");
      \u0275\u0275text(20, "Select date range");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "mat-date-range-input", 17);
      \u0275\u0275element(22, "input", 18)(23, "input", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275element(24, "mat-datepicker-toggle", 20)(25, "mat-date-range-picker", null, 0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "div", 21)(28, "div", 7)(29, "div", 22)(30, "h4");
      \u0275\u0275text(31, "Adults");
      \u0275\u0275elementEnd();
      \u0275\u0275element(32, "zafira-increment-control", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "div", 22)(34, "h4");
      \u0275\u0275text(35, "Children");
      \u0275\u0275elementEnd();
      \u0275\u0275element(36, "zafira-increment-control", 24);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "div", 22)(38, "h4");
      \u0275\u0275text(39, "Rooms");
      \u0275\u0275elementEnd();
      \u0275\u0275element(40, "zafira-increment-control", 25);
      \u0275\u0275elementEnd()()()()()();
      \u0275\u0275elementStart(41, "div", 13)(42, "h4");
      \u0275\u0275element(43, "i", 26);
      \u0275\u0275text(44, " Select your rooms");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(45, "div", 27);
      \u0275\u0275repeaterCreate(46, BookingComponent_For_47_Template, 11, 10, "div", 28, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(48, BookingComponent_Conditional_48_Template, 36, 7, "div", 29);
      \u0275\u0275elementStart(49, "div", 13)(50, "h4");
      \u0275\u0275element(51, "i", 30);
      \u0275\u0275text(52, " Enter your personal details");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(53, "div", 7)(54, "div", 31)(55, "div", 32);
      \u0275\u0275element(56, "input", 33);
      \u0275\u0275template(57, BookingComponent_Conditional_57_Template, 2, 0, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "div", 32);
      \u0275\u0275element(59, "input", 35);
      \u0275\u0275template(60, BookingComponent_Conditional_60_Template, 2, 0, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(61, "div", 32);
      \u0275\u0275element(62, "input", 36);
      \u0275\u0275template(63, BookingComponent_Conditional_63_Template, 2, 0, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "div", 32);
      \u0275\u0275element(65, "input", 37);
      \u0275\u0275template(66, BookingComponent_Conditional_66_Template, 2, 0, "div", 34);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(67, "div", 31)(68, "div", 38);
      \u0275\u0275element(69, "textarea", 39);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(70, "div", 40)(71, "div", 41);
      \u0275\u0275element(72, "input", 42);
      \u0275\u0275declareLet(73);
      \u0275\u0275template(74, BookingComponent_Conditional_74_Template, 2, 0);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(75, BookingComponent_Conditional_75_Template, 3, 0, "div", 43);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275element(76, "zafira-footer", 44);
      \u0275\u0275elementEnd();
      \u0275\u0275element(77, "zafira-dialog", 45, 1);
      \u0275\u0275template(79, BookingComponent_Conditional_79_Template, 2, 0, "div", 46)(80, BookingComponent_Conditional_80_Template, 2, 0, "div", 46);
    }
    if (rf & 2) {
      const picker_r10 = \u0275\u0275reference(26);
      \u0275\u0275advance(9);
      \u0275\u0275conditional(ctx.bookingStatus() === "ERROR" ? 9 : ctx.bookingStatus() === "PENDING" ? 10 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("formGroup", ctx.frm);
      \u0275\u0275advance(10);
      \u0275\u0275property("rangePicker", picker_r10)("min", ctx.minDate);
      \u0275\u0275advance(3);
      \u0275\u0275property("for", picker_r10);
      \u0275\u0275advance(22);
      \u0275\u0275repeater(ctx.roomTypes.controls);
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.selectedRooms().length > 0 ? 48 : -1);
      \u0275\u0275advance(7);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(21, _c03, ctx.firstName.touched && ctx.firstName.invalid, ctx.firstName.valid && ctx.firstName.touched));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.firstName.touched && ctx.firstName.hasError("required") ? 57 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(24, _c03, ctx.email.touched && ctx.email.invalid, ctx.email.valid && ctx.email.touched));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.email.touched && (ctx.email.hasError("required") || ctx.email.hasError("pattern")) ? 60 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(27, _c03, ctx.phone.touched && ctx.phone.invalid, ctx.phone.valid && ctx.phone.touched));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.phone.touched && ctx.phone.hasError("pattern") ? 63 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(30, _c03, ctx.idNumber.touched && ctx.idNumber.invalid, ctx.idNumber.valid && ctx.idNumber.touched));
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.idNumber.touched && ctx.idNumber.hasError("required") ? 66 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275property("value", ctx.bookingStatus() === "LOADING" ? "Processing..." : "Confirm Reservation")("disabled", ctx.frm.invalid || ctx.bookingStatus() === "LOADING" || ctx.bookingStatus() === "PENDING");
      \u0275\u0275advance();
      const reservation_r11 = \u0275\u0275storeLet(ctx.activeReservation());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.bookingStatus() === "PENDING" && !ctx.windowRef && reservation_r11 && reservation_r11.payments[0] ? 74 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.bookingStatus() === "SUCCESS" ? 75 : -1);
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.bookingStatus() === "LOADING" ? 79 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.roomStatus() === "LOADING" ? 80 : -1);
    }
  }, dependencies: [
    ReactiveFormsModule,
    \u0275NgNoValidate,
