...
var OwlLogger = class _OwlLogger {
  ...
  static \u0275fac = function OwlLogger_Factory(\u0275t) {
    return new (\u0275t || _OwlLogger)(\u0275\u0275inject(ErrorHandler));
  };
...
var CarouselService = class _CarouselService {
  ...
  static \u0275fac = function CarouselService_Factory(\u0275t) {
    return new (\u0275t || _CarouselService)(\u0275\u0275inject(OwlLogger));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var NavigationService = class _NavigationService {
  ...
  static \u0275fac = function NavigationService_Factory(\u0275t) {
    return new (\u0275t || _NavigationService)(\u0275\u0275inject(CarouselService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var BrowserWindowRef = class _BrowserWindowRef extends WindowRef {
  ...
  static \u0275fac = function BrowserWindowRef_Factory(\u0275t) {
    return new (\u0275t || _BrowserWindowRef)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var BrowserDocumentRef = class _BrowserDocumentRef extends DocumentRef {
  ...
  static \u0275fac = function BrowserDocumentRef_Factory(\u0275t) {
    return new (\u0275t || _BrowserDocumentRef)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var AutoplayService = class _AutoplayService {
  ...
  static \u0275fac = function AutoplayService_Factory(\u0275t) {
    return new (\u0275t || _AutoplayService)(\u0275\u0275inject(CarouselService), \u0275\u0275inject(WINDOW), \u0275\u0275inject(DOCUMENT), \u0275\u0275inject(NgZone));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var LazyLoadService = class _LazyLoadService {
  ...
  static \u0275fac = function LazyLoadService_Factory(\u0275t) {
    return new (\u0275t || _LazyLoadService)(\u0275\u0275inject(CarouselService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var AnimateService = class _AnimateService {
  ...
  static \u0275fac = function AnimateService_Factory(\u0275t) {
    return new (\u0275t || _AnimateService)(\u0275\u0275inject(CarouselService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var AutoHeightService = class _AutoHeightService {
  ...
  static \u0275fac = function AutoHeightService_Factory(\u0275t) {
    return new (\u0275t || _AutoHeightService)(\u0275\u0275inject(CarouselService));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var HashService = class _HashService {
  ...
  static \u0275fac = function HashService_Factory(\u0275t) {
    return new (\u0275t || _HashService)(\u0275\u0275inject(CarouselService), \u0275\u0275inject(ActivatedRoute, 8), \u0275\u0275inject(Router, 8));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    token: _HashService,
...
var CarouselSlideDirective = class _CarouselSlideDirective {
  ...
  static \u0275fac = function CarouselSlideDirective_Factory(\u0275t) {
    return new (\u0275t || _CarouselSlideDirective)(\u0275\u0275directiveInject(TemplateRef));
  };
...
var ResizeService = class _ResizeService {
  ...
  static \u0275fac = function ResizeService_Factory(\u0275t) {
    return new (\u0275t || _ResizeService)(\u0275\u0275inject(WINDOW), \u0275\u0275inject(PLATFORM_ID));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
var StageComponent = class _StageComponent {
  ...
  */
  ...
  static \u0275fac = function StageComponent_Factory(\u0275t) {
    return new (\u0275t || _StageComponent)(\u0275\u0275directiveInject(NgZone), \u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(CarouselService), \u0275\u0275directiveInject(AnimateService));
  };
...
var OwlRouterLinkDirective = class _OwlRouterLinkDirective {
  ...
  static \u0275fac = function OwlRouterLinkDirective_Factory(\u0275t) {
    return new (\u0275t || _OwlRouterLinkDirective)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275injectAttribute("tabindex"), \u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(ElementRef));
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var OwlRouterLinkWithHrefDirective = class _OwlRouterLinkWithHrefDirective {
  ...
  static \u0275fac = function OwlRouterLinkWithHrefDirective_Factory(\u0275t) {
    return new (\u0275t || _OwlRouterLinkWithHrefDirective)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(LocationStrategy));
  };
  static \u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
var CarouselModule = class _CarouselModule {
  static \u0275fac = function CarouselModule_Factory(\u0275t) {
    return new (\u0275t || _CarouselModule)();
  };
...
// node_modules/ngxtension/fesm2022/ngxtension-derived-async.mjs
function derivedAsync(computation, options = {}) {
  return assertInjector(derivedAsync, options?.injector, () => {
    ...
    let sourceValue;
    if (options?.requireSync && options?.initialValue === void 0) {
      const initialCmp = computation(void 0);
    ...
    if (options?.requireSync && sourceValue().kind === 0) {
    ...
    effect(() => {
      const currentValue = untracked(() => {
        ...
        return currentSourceValue.kind === 1 ? currentSourceValue.value : void 0;
      });
...
var REQUIRE_SYNC_PROMISE_MESSAGE = `Promises cannot be used with requireSync. Pass an initialValue or set requireSync to false.`;
var REQUIRE_SYNC_ERROR_MESSAGE = `The observable passed to derivedAsync() did not emit synchronously. Pass an initialValue or set requireSync to false.`;
...
// src/app/room/components/room-detail/room-detail.component.ts
var _c02 = (a0) => ({ room: a0 });
var _c12 = (a0) => ["/rooms/booking", a0];
var _c22 = (a0, a1) => ({ height: a0, width: a1 });
function RoomDetailComponent_For_13_ng_template_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 27)(2, "a", 28);
    \u0275\u0275listener("click", function RoomDetailComponent_For_13_ng_template_0_Template_a_click_2_listener() {
      \u0275\u0275restoreView(_r2);
      const $index_r3 = \u0275\u0275nextContext().$index;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openGallery($index_r3));
    });
    \u0275\u0275elementStart(3, "span", 29)(4, "span", 30);
    \u0275\u0275element(5, "i", 31);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", item_r5.text, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngSrc", item_r5.imageUrl)("width", item_r5.imageWidth)("height", ctx_r3.sliderHeight)("loaderParams", \u0275\u0275pureFunction2(5, _c22, ctx_r3.floor(ctx_r3.sliderHeight * 0.8), ctx_r3.floor(item_r5.imageWidth * 0.8)));
  }
}
function RoomDetailComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, RoomDetailComponent_For_13_ng_template_0_Template, 9, 8, "ng-template", 11);
  }
  if (rf & 2) {
    const item_r5 = ctx.$implicit;
    \u0275\u0275property("width", item_r5.imageWidth)("id", item_r5.id);
  }
}
function RoomDetailComponent_For_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(facility_r7);
  }
}
function RoomDetailComponent_ForEmpty_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275text(1, "This room are no facilities.");
    \u0275\u0275elementEnd();
  }
}
var RoomDetailComponent = class _RoomDetailComponent {
  roomSrv = inject(RoomService);
  imgLoader = inject(IMAGE_LOADER);
  dialog = inject(MatDialog);
  sliderHeight = 320;
  // IN PX
  roomData = this.roomSrv.activeRoom;
  subHeaderInfo = computed(() => this.roomData()?.name.split(" ") ?? ["Standar", "Room"]);
  slideData = derivedAsync(() => this._buildSlideList(this.roomData()?.images ?? []).then((rta) => rta), { initialValue: [] });
  customOptions = {
    center: false,
    items: 3,
    margin: 20,
  ...
  /* ngOnDestroy(): void {
    this.roomSrv.clearSelectedRoom();
  } */
  floor(w) {
    return Math.floor(w);
  }
  openGallery(index) {
    this.dialog.open(GalleryDialogComponent, {
      ...
      data: {
        images: this.slideData(),
        initialIndex: index
      }
    });
  }
  _buildSlideList(list) {
    return __async(this, null, function* () {
      ...
      for (let i = 0; i < list.length; i++) {
        rta.push({
          ...
          imageUrl: list[i].url,
          imageWidth: Math.floor(this.sliderHeight * (list[i].width / list[i].height)),
          imageHeight: this.sliderHeight
        });
      }
      return rta;
    });
  }
  static \u0275fac = function RoomDetailComponent_Factory(\u0275t) {
    return new (\u0275t || _RoomDetailComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RoomDetailComponent, selectors: [["zafira-room-detail"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 49, vars: 15, consts: [["owlCar", ""], ["id", "background"], ["id", "content-absolute"], [3, "title", "subtitle"], ["id", "section-main", "data-wow-delay", "1.5s", "aria-label", "section-menu", 1, "no-bg", "no-top", "wow", "fadeInUp", "animated"], [1, "container"], [1, "row"], [1, "col-md-12"], [1, "de-content-overlay"], ["data-wow-delay", "2s", "id", "gallery", 1, "d-carousel", "wow", "fadeInRight"], [3, "options"], ["carouselSlide", "", 3, "width", "id"], [1, "d-arrow-left", "mod-a", 3, "click"], [1, "fa", "fa-angle-left"], [1, "d-arrow-right", "mod-a", 3, "click"], [1, "fa", "fa-angle-right"], [1, "d-room-details", "de-flex"], [1, "de-flex-col"], ["src", "images/ui/user.svg", "alt", ""], ["src", "images/ui/floorplan.svg", "alt", ""], ["src", "images/ui/bed.svg", "alt", ""], [1, "btn-main", 3, "routerLink"], [1, "col-md-8"], [1, "col-md-4"], [1, "ul-style-2"], ["containerClass", "container-fluid"], [1, "item"], [1, "picframe"], [1, "image-popup-gallery", "action-elem", 3, "click"], [1, "overlay"], [1, "pf_title"], [1, "icon_search"], [1, "pf_caption"], ["alt", "", 3, "ngSrc", "width", "height", "loaderParams"]], template: function RoomDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "zafira-float-text")(1, "div", 1);
      \u0275\u0275elementStart(2, "div", 2);
      \u0275\u0275element(3, "zafira-subheader", 3);
      \u0275\u0275elementStart(4, "section", 4)(5, "div", 5)(6, "div", 6)(7, "div", 7)(8, "div", 8)(9, "div", 9)(10, "owl-carousel-o", 10, 0);
      \u0275\u0275repeaterCreate(12, RoomDetailComponent_For_13_Template, 1, 2, null, 11, \u0275\u0275repeaterTrackByIndex);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "div", 12);
      \u0275\u0275listener("click", function RoomDetailComponent_Template_div_click_14_listener() {
        \u0275\u0275restoreView(_r1);
        const owlCar_r6 = \u0275\u0275reference(11);
        return \u0275\u0275resetView(owlCar_r6.prev());
      });
      \u0275\u0275element(15, "i", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "div", 14);
      \u0275\u0275listener("click", function RoomDetailComponent_Template_div_click_16_listener() {
        \u0275\u0275restoreView(_r1);
        const owlCar_r6 = \u0275\u0275reference(11);
        return \u0275\u0275resetView(owlCar_r6.next());
      });
      \u0275\u0275element(17, "i", 15);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 6);
      \u0275\u0275declareLet(19);
      \u0275\u0275elementStart(20, "div", 7)(21, "div", 16)(22, "div", 17);
      \u0275\u0275element(23, "img", 18);
      \u0275\u0275text(24);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275pipe(31, "currency");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "div", 17)(33, "a", 21)(34, "span");
      \u0275\u0275text(35, "Book Now");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(36, "div", 22)(37, "h3");
      \u0275\u0275text(38, "Room Overview");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "p");
      \u0275\u0275text(40);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(41, "div", 23)(42, "h3");
      \u0275\u0275text(43, "Room Facilities");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "ul", 24);
      \u0275\u0275repeaterCreate(45, RoomDetailComponent_For_46_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIndex, false, RoomDetailComponent_ForEmpty_47_Template, 2, 0, "li");
      \u0275\u0275elementEnd()()()()()()()();
      \u0275\u0275element(48, "zafira-footer", 25);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_6_0;
      ...
      let tmp_9_0;
      \u0275\u0275advance(3);
      \u0275\u0275property("title", ctx.subHeaderInfo().length > 1 ? ctx.subHeaderInfo()[1] : "Room")("subtitle", ctx.subHeaderInfo().length > 0 ? ctx.subHeaderInfo()[0] : "Standard");
      \u0275\u0275advance(7);
      \u0275\u0275property("options", ctx.customOptions);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.slideData());
      const room_r8 = ctx.roomData();
      \u0275\u0275advance(12);
      \u0275\u0275textInterpolate1(" ", (tmp_6_0 = room_r8 == null ? null : room_r8.capacity) !== null && tmp_6_0 !== void 0 ? tmp_6_0 : 0, " Guests ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", (tmp_7_0 = room_r8 == null ? null : room_r8.dimensions) !== null && tmp_7_0 !== void 0 ? tmp_7_0 : 0, " ft ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(31, 9, (tmp_8_0 = room_r8 == null ? null : room_r8.price) !== null && tmp_8_0 !== void 0 ? tmp_8_0 : 0), " / Night ");
      \u0275\u0275advance(3);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(13, _c12, \u0275\u0275pureFunction1(11, _c02, (tmp_9_0 = ctx.roomData()) == null ? null : tmp_9_0.$id)));
      \u0275\u0275advance(7);
      \u0275\u0275textInterpolate1(" ", room_r8 == null ? null : room_r8.description, " ");
      \u0275\u0275advance(5);
      \u0275\u0275repeater(room_r8 == null ? null : room_r8.facilities);
    }
  }, dependencies: [
    FloatTextComponent,
    SubheaderComponent,
    ...
    NgOptimizedImage,
    MatDialogModule
  ], styles: ['\n\n#background[_ngcontent-%COMP%] {\n  background: url("./media/bg-SRBFDLD3.jpg") 0% 0% / cover fixed;\n}\n.d-carousel[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  align-items: center;\n  overflow: hidden;\n  min-height: 366.09px;\n}\n.d-arrow-left[_ngcontent-%COMP%], \n.d-arrow-right[_ngcontent-%COMP%] {\n  cursor: pointer;\n  position: absolute;\n  margin-top: -45px;\n  z-index: 100;\n  width: 30px;\n  height: 60px;\n  background-color: rgba(255, 255, 255, 1);\n}\n.d-arrow-left[_ngcontent-%COMP%] {\n  left: -30px;\n  border-top-right-radius: 110px;\n  border-bottom-right-radius: 110px;\n}\n.d-arrow-right[_ngcontent-%COMP%] {\n  right: -30px;\n  border-top-left-radius: 110px;\n  border-bottom-left-radius: 110px;\n}\n.d-arrow-left[_ngcontent-%COMP%]   i[_ngcontent-%COMP%], \n.d-arrow-right[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 20px;\n  color: #111111;\n  font-size: 20px;\n  font-weight: bold;\n}\n.d-arrow-left[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  left: 8px;\n}\n.d-arrow-right[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  right: 8px;\n}\n.d-carousel[_ngcontent-%COMP%]:hover   .d-arrow-left[_ngcontent-%COMP%] {\n  left: 0;\n}\n.d-carousel[_ngcontent-%COMP%]:hover   .d-arrow-right[_ngcontent-%COMP%] {\n  right: 0;\n}\n.de-content-overlay[_ngcontent-%COMP%] {\n  overflow: hidden;\n  padding: 30px;\n  background: rgba(var(--bg-dark-color), 0.6);\n}\n.d-room-details[_ngcontent-%COMP%] {\n  border: solid 1px rgba(255, 255, 255, 0.3);\n  padding: 30px;\n  margin-top: 15px;\n  margin-bottom: 30px;\n  font-size: 18px;\n  color: #ffffff;\n}\n.d-room-details[_ngcontent-%COMP%]   img[_ngcontent-%COMP%], \n.d-room-details[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {\n  margin-right: 20px;\n  width: 32px;\n  height: 32px;\n}\n.ul-style-2[_ngcontent-%COMP%] {\n  padding: 0;\n  list-style: none;\n}\n.ul-style-2[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  margin: 5px 0 5px 0;\n}\n.ul-style-2[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]:before {\n  font-family: "FontAwesome";\n  content: "\\f00c";\n  margin-right: 15px;\n}\n.item[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 100%;\n  height: auto;\n}\n.picframe[_ngcontent-%COMP%]   .overlay[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 28px;\n}\n.picframe[_ngcontent-%COMP%] {\n  position: relative;\n  overflow: hidden;\n}\nspan.overlay[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: absolute;\n  vertical-align: center;\n  width: calc(100% - 10px);\n  height: calc(100% - 10px);\n  margin: 5px 0 0 5px;\n  background: rgba(var(--bg-dark-color), 0);\n  z-index: 100;\n}\n.picframe[_ngcontent-%COMP%]   .overlay[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  opacity: 0;\n}\n.picframe[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  position: relative;\n  width: 100%;\n}\n.picframe[_ngcontent-%COMP%]:hover   .overlay[_ngcontent-%COMP%] {\n  background: rgba(var(--bg-dark-color), 0.7);\n}\n.picframe[_ngcontent-%COMP%]:hover   .overlay[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  opacity: 1;\n}\n.picframe[_ngcontent-%COMP%]:hover   .pf_caption[_ngcontent-%COMP%] {\n  bottom: 20px;\n  opacity: 1;\n}\n.picframe[_ngcontent-%COMP%]:hover   img[_ngcontent-%COMP%] {\n  transform: scale(1.1);\n}\n.pf_title[_ngcontent-%COMP%] {\n  display: block;\n}\n.pf_title[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 20px;\n}\n.pf_caption[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0px;\n  opacity: 0;\n  font-size: 15px;\n}\nowl-carousel-o[_ngcontent-%COMP%] {\n  width: 100%;\n}\n@media only screen and (max-width: 992px) {\n  .d-room-details.de-flex[_ngcontent-%COMP%] {\n    display: block;\n  }\n  .d-room-details[_ngcontent-%COMP%]   .de-flex-col[_ngcontent-%COMP%] {\n    display: block;\n    margin-bottom: 20px;\n  }\n  .d-room-details[_ngcontent-%COMP%]   .de-flex-col[_ngcontent-%COMP%]:last-child {\n    margin-bottom: 0;\n  }\n}\n.action-elem[_ngcontent-%COMP%] {\n  cursor: pointer;\n}'], changeDetection: 0 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RoomDetailComponent, { className: "RoomDetailComponent", filePath: "src\\app\\room\\components\\room-detail\\room-detail.component.ts", lineNumber: 40 });
})();
export {
  RoomDetailComponent
};
